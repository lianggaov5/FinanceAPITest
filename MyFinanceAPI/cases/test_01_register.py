...
class TestRegister(unittest.TestCase):
    ...
    def test_register(self, data_namedtuple):
        ...
        response = TestRegister.do_request(method=data_namedtuple.method,
                                           url=do_config("api", "prefix_url")+data_namedtuple.url,
                                           data=HandleParameter.register_parameter(data_namedtuple.data))
